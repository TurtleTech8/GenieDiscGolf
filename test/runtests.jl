...
# !!! Main.UserApp is configured as an alias for Main.GenieDiscGolf and you might encounter it in some tests
using Main.GenieDiscGolf, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "GenieDiscGolf tests" begin
  @includetests ARGS
end
